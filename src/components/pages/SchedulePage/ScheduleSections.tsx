...
const ScheduleSections: React.FC<PropsProvider> = ({ dayOfWeek }): JSX.Element => {
   ...
   useEffect(() => {
      ...
      switch(groupSelected) {
         case NORMAL_GROUPS[0].text:   englishGroup(NORMAL_GROUPS[0].field);  break;
         case NORMAL_GROUPS[1].text:   englishGroup(NORMAL_GROUPS[1].field);  break;
         default:                      throw new Error('Selected group not exist!');
      }
