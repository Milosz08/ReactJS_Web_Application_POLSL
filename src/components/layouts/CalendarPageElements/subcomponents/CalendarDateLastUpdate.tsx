 ...
 */
const CalendarDateLastUpdate: React.FC = (): JSX.Element => (
    <CalendarLastUpdateContainer>
        <CalendarLastUpdateWrapper>
            <DataLastUpdate
                type = {updateSections.CALENDAR}
                content = 'kalendarza'
            />
        </CalendarLastUpdateWrapper>
    </CalendarLastUpdateContainer>
...
export default CalendarDateLastUpdate;