...
import { CustomContentForHelpersLinksAddEditContainer } from './CustomContentForHelpersLinksAddEdit.styles';
 ...
 */
const CustomContentForHelpersLinksAddEdit: React.FC<PropsProvider> = ({ modalData }): JSX.Element => {
...
export default CustomContentForHelpersLinksAddEdit;