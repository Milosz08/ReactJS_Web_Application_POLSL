...
/**
 * Component responsible for generating subjects list header in single day of week.
 */
const ChangeScheduleHeader: React.FC = (): JSX.Element => {
...
export default ChangeScheduleHeader;