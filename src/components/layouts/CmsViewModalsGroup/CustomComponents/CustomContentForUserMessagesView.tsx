...
import { CustomContentContainer } from '../../CmsDeleteModalsGroup/DeleteContentModal/DeleteContentModal.styles';
 ...
 */
const CustomContentForUserMessagesView: React.FC = (): JSX.Element => {
...
export default CustomContentForUserMessagesView;