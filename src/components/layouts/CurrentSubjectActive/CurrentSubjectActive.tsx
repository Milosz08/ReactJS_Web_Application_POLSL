...
const CurrentSubjectActive: React.FC = (): JSX.Element => (
    <CurrentSubjectActiveContainer>
        <CurrentSubjectActiveWrapper>
            <UniversalHeader
                iconP = {{ family: IconFamiliesType.FontAwesomeIcons, name: 'FaUserClock' }}
                content = 'Aktualnie odbywające się Zajęcia'
                ifCloseButtonVisible = {false}
                changeIconSize = '1.6rem'
            />
            <CurrentSubjectContent/>
            <CurrentSubjectImportantInfo/>
        </CurrentSubjectActiveWrapper>
    </CurrentSubjectActiveContainer>
);

export default CurrentSubjectActive;