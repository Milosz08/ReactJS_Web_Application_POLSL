...
const DevToolsContent: React.FC = (): JSX.Element => (
    <DevToolsTextContentContainer>
        <DevToolsMainContent>
            ...
            <strong> Java Spring Framework </strong> wspomaganym przez <strong>JPA</strong> i <strong>Hibernate</strong> wraz
            z komunikującą się z nim bazą danych <strong> mySQL</strong>. Całość warstwy front-end aplikacji została napisana
            w języku <strong>TypeScript</strong>. Kod projektu znajdziesz na moim repozytorium:{' '}
            <DevToolsGithubLink
