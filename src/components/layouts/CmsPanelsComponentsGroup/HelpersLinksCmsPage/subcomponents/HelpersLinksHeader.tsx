...
/**
 * Component responsible for generating header structure for helpers links CMS page list.
 */
const HelpersLinksHeader: React.FC = (): JSX.Element => {
...
export default HelpersLinksHeader;