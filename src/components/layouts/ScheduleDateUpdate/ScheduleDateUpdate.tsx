 ...
 */
const ScheduleDateUpdate: React.FC = (): JSX.Element => (
    <ScheduleDateUpdateContainer>
        <ScheduleDateUpdateWrapper>
            <DataLastUpdate
                type = {updateSections.SCHEDULE}
                content = 'planu zajęć'
            />
        </ScheduleDateUpdateWrapper>
    </ScheduleDateUpdateContainer>
...
export default ScheduleDateUpdate;