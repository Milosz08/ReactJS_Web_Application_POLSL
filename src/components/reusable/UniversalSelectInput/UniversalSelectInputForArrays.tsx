...
/**
 * Universal component responsible for generating select input with options for arrays 1sr root elements.
 *
 ...
 */
const UniversalSelectInputForArrays: React.FC<PropsProvider> = ({
...
export default UniversalSelectInputForArrays;